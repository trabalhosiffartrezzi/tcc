...
<body>
  <div class="container w-70">
    <ul class="nav justify-content-center">
      ...
      ?>
        <a class="nav-link" href="todosospedidos.php"><i class="fas fa-backward">Voltar</i></a>
...
$sql_listar = "select produto.idprod, produto.nomeprod, produto.valor, venda_produto.idvp, venda_produto.qtde_unidade, venda_produto.total_un, venda_pedido.uservendedorid
  ...
  where 
   ...
   if ( mysqli_num_rows($lista) > 0 ) {
    ...
    $sql_pedido = "select venda_pedido.userclienteid, venda_pedido.idvendap, venda_pedido.userclienteid, usuario.iduser, usuario.nome, usuario.cpf_cnpj, endereco.idenderec, endereco.rua, endereco.numero, endereco.bairro, endereco.cidadeid, cidade.idcidade, cidade.nomecidade, pagamento.condicaopgto, pagamento.prazopgto, pagamento.observacao, pagamento.vendapid
        from 
            venda_pedido, usuario, endereco, cidade, pagamento
        where 
            ...
            pagamento.vendapid = venda_pedido.idvendap and 
    ...
    $tabela=$tabela."<tr><th colspan='6'>Condição de Pagamento: ".$resultado["condicaopgto"]." - Prazo: ".$resultado["prazopgto"]."</th></tr>";
