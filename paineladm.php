...
<body>
	...
	<br>
	<div class="container w-70">
  	<a href="novopedido.php"><button type="button" class="btn btn-primary btn-lg btn-block">Fazer uma venda</button></a>
	</div>
	<br>
	<br>
	</div>
	...
	<div class="container w-70">
  	<a href="todosospedidos.php"><button type="button" class="btn btn-primary btn-lg btn-block">Ver todos os pedidos pedidos</button></a>
	</div><br>
	<br>
	</div>
	<div class="container w-70">
